...
function SnakeGame(canvasWidth, canvasHeight, blockSize, delay)
{
    ...
    this.gameOver = function()
    {
        ...
        this.ctx.strokeText("Apuuyer sur la touche Espace pour rejouer", centreX, centreY - 120);
        this.ctx.fillText("Apuuyer sur la touche Espace pour rejouer", centreX, centreY - 120);        
        this.ctx.restore();
    }
